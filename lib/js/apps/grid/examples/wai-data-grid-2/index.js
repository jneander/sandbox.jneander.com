...
const columns = [
  { label: 'Date', getValue (datum) { return datum.date } },
  { label: 'Type', getValue (datum) { return datum.type } },
  { label: 'Description', getValue (datum) { return datum.description } },
  { label: 'Amount', getValue (datum) { return datum.amount } },
  { label: 'Balance', getValue (datum) { return datum.balance } }
];
